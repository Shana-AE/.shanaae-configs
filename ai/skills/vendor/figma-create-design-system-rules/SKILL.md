...
description: Generate project-level design system rules for Figma-to-code work by analyzing the codebase (components, design tokens, styling, architecture) and saving them to CLAUDE.md/AGENTS.md. Use when the user asks to "create design system rules", "set up Figma guidelines", "customize Figma rules for my project", or wants rules like "prefer existing components", "never hardcode colors", "use project tokens" applied to Figma implementation tasks.
---

# Create Design System Rules

> Upstream source: [figma/mcp-server-guide](https://github.com/figma/mcp-server-guide) — `figma-power/steering/create-design-system-rules.md` (the former `figma-create-design-system-rules` skill, now shipped as steering guidance). Wrapped as a skill locally on 2026-09-07.

## Overview

This skill helps you generate custom design system rules tailored to your project's specific needs. These rules guide the agent to produce consistent, high-quality code when implementing Figma designs, ensuring that your team's conventions, component patterns, and architectural decisions are followed automatically.
...
- Onboarding an agent to an existing project with established patterns
...
- What CSS framework or approach is used? (Tailwind, CSS Modules, styled-components, UnoCSS, etc.)
...
### Step 4: Save Rules to CLAUDE.md (or AGENTS.md)

Guide the user to save the generated rules to the `CLAUDE.md` file in their project root (or `AGENTS.md` for agents that read AGENTS.md, e.g. opencode / Codex):
...
4. Save to `CLAUDE.md` (or `AGENTS.md`) in project root
...
### Issue: Too many rules make the agent slow
...
Design system rules transform how the agent works with your Figma designs:
