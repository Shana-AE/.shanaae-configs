...
description: Manage Obsidian notes (read, write, list, search, delete) using the Local REST API and a Python client. use this skill when need to manipulate obsidian files.
---
